...
export default function DoughnutChart({ chartData, chartOptions, title, icon, iconColor, showControls = true, showExport = true, onExportExcel, onExportPDF, onExportJSON }) {
